...
<!--        <el-carousel-item v-for="(item,index) in swiperList" :key="index">-->
          <img src='https://xyxiaobiao-1314787675.cos.ap-guangzhou.myqcloud.com/img/1.png'/>
<!--        </el-carousel-item>-->
        <div class="scene">
      ...
      <div class="h-information">
        ...
        <h2 class="h-description">
          {{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "LmBo的博客" }}
        </h2>
      </div>
    </div>
